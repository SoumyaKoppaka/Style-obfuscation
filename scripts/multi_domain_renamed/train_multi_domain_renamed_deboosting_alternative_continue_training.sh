...
python src/main.py \
        ...
        --vocab_boost \
        --vocab_weights data/multi_domain_renamed/saved_dict_alternative.json \
        --boost_w 25 \
        --load_model \
        --output_dir outputs_multi_domain_renamed/multi_domain_renamed_wd0.1_wb0.2_ws3.0_an5_pool1_klw0.008_lr0.001_lrdec0.5_gs0.01_lm_bt_gs_hard_avglen_klrev3_flctrl_boost25.0_date_ \
        #--one_lm \
        #--disced_lm \
        #--automated_multi_domain \
        #--one_lm \
