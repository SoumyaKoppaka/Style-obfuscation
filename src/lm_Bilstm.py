...
class LSTM_LM(nn.Module):
  ...
  def __init__(self, model_init, emb_init, hparams):
    ...
    #print("Hiiii ", model_init, emb_init, hparams.d_model, self.embed)
    ...
    # prediction layer
    self.pred_linear = nn.Linear(2*self.nh, hparams.src_vocab_size, bias=True)
  ...
  def decode(self, x, x_len, gumbel_softmax=False):
    ...
    c_init = word_embed.new_zeros((2, batch_size, self.nh))
    h_init = word_embed.new_zeros((2, batch_size, self.nh))
    #print("Byeee ",packed_embed)
